...
public class TestCourier {
	...
	public static void main(String[] args) {
		...
		Deposit deposit2 = new Deposit(101, "Botosani", 250.0);
		Deposit deposit3 = new Deposit(102, "Iasi", 200.0);
		bookno1.addToTheListOfDeposits(deposit1);
		bookno1.addToTheListOfDeposits(deposit2);
		bookno1.addToTheListOfDeposits(deposit3);
		System.out.println("-------------------------------------------------------------");
		...
		delivery1.valueOfDelivery(package1);
		...
		deposit2.checkPackagesFromDeposit();
...
//		courier1.calculateSalary(Departaments.Delivery, 200);
		...
		System.out.println("-------------------------------------------------------------");
		bookno1.showDepositsSortedByLocation().stream().forEach(dep -> System.out.println(dep + " "));
		System.out.println("-------------------------------------------------------------");
		bookno1.findDepositDetails("Iasi").stream().forEach(depo -> System.out.println(depo + " "));
	}
